...
if (strpos($url,'roksprocket-edit') !== false) {
	function add_files() {		
		echo '<link rel="stylesheet" href="'. plugins_url( 'e4r-style.css', __FILE__ ) .'" type="text/css" /><script type="text/javascript" src="'. plugins_url( 'nicEdit/nicEdit.js', __FILE__ ) .'"></script><script type="text/javascript" src="'. plugins_url( 'editor4roks.js', __FILE__ ) .'"></script>';
	}
	function add_html() {
